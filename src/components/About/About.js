...
import Hearts from "../../assets/image/About/me.png";
import { Container, Title, ProjectInfo, Content, Image } from "./styles";
  ...
  return (
    <Container id="about">
      ...
      <Content  className="info"  ref={infoRef}>
        <ProjectInfo>
          ...
          <div>
            ...
            <p>
              ...
              Using <b>Adobe Photoshop, HTML5, CSS3, Flexbox, Grid, Javascript,
              Gsap, Bootstrap, Material-UI, Storybook, Context API, ReactJS</b> and <b>StyledComponents</b>.
            </p>
          </div>
        ...
        <Image>
          <img src={Hearts} alt="Foto de corações" />
        </Image>
      </Content>
    </Container>
  );
